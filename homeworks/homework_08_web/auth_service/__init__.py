...
def create_app():
    ...
    logging_setup(app)
    logging.info('...::: Flask auth_service setup starts :::...')

    app.config.from_mapping(
        DATABASE='auth_service/auth_storage.db',
        SQLALCHEMY_DATABASE_URI='sqlite:///auth_storage.db',
        SQLALCHEMY_TRACK_MODIFICATIONS=False,
        SECRET_KEY='9OLWxND4o83j4K4iuopO'
    )

    from auth_service.models import UsersTable
    ...
    from auth_service.service import service
    app.register_blueprint(service.auth_bp)
