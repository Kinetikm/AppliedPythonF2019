...
from flight.db_func import get_all_flights, get_one_flight, add_flight, change_flight, delete_flight, get_all_airports, \
...
def index():
    ...
    user = requests.get('http://0.0.0.0/user_login', cookies=request.cookie)
    add_flight(user['id'], format_data)
