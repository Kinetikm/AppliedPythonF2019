...
class Tensor:
    ...
    def __calcul_result_of_operation(self, other, operator):
    ...
    def __add__(self, other):
        return self.__calcul_result_of_operation(other, '+')

    def __radd__(self, other):
        return self + other

    def __sub__(self, other):
        return self.__calcul_result_of_operation(other*(-1), '+')
    ...
    def __truediv__(self, other):
        ...
        return self.__calcul_result_of_operation(1/other, '*')
