...
urls_for_enum = [Urls('put', 'http://localhost:5000/flight', None, {
...
urls_for_enum.append(Urls('post', 'http://localhost:5000/flight/1', None, {
    "destination_airport": "svo",
    "arrival_time": 1,
    }, None))
urls_for_enum.append(Urls('delete', 'http://localhost:5000/flight/1', None, None, None))
